							...
							// 				(result:any)=>{
								...
								// 			},error=>{
									...
									// 				if (errorMensaje != null) {
										...
										guardarVideo(){
											this.contenido.idFormatodocumento_Contenido = 'mp4';
											this.contenido.idTema_Contenido = this.idTema;		
											this.contenido.rutaContenido = this.contenido.rutaContenido.replace("https://youtu.be/", "https://www.youtube.com/embed/");
											this._contenidoService.registraContenido(this.contenido).subscribe(
												response=>{
													console.log(response.contenido);
